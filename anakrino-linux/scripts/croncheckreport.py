    ...
    with gzip.open(splunkReportFile, 'rt') as f:
        ...
        for row in splunkReader:
            try:
                ...
                report += '<td>' + row['exe'] + '</td>'
                report += '<td>' + row['mode'] + '</td>'
                report += '<td>' + row['owner'] + '</td>'
                report += '<td>' + row['group'] + '</td>'
                report += '<td>' + row['mountpoint'] + '</td>'
                report += '<td>' + row['fstype'] + '</td>'
