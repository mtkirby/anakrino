...
for o, a in opts:
    if o in ("--file"):
        ...
        splunkUrl += '/app/search/search?earliest=-7d%40h&lastest=now&q=search%20index%3Danakrino-pkgcheck%20sourcetype%3Dprocpkgcheck'
    elif o in ("--mailfrom"):
        mailFrom = a
    elif o in ("--mailto"):
        mailTo = a
...
msg['Subject'] = 'procpkgcheck report'
msg['From'] = mailFrom
msg['To'] = mailTo
